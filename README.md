...
BASE_URL="https://raw.githubusercontent.com/RainCatStar-lit/Ubuntu-tailscale-remote-access/${BRANCH}"
...
git clone --branch TEST-IN-22.04 \
  https://github.com/RainCatStar-lit/Ubuntu-tailscale-remote-access.git
